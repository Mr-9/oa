...
<div class="table-operate ue-clear">
    ...
    <a href="/book1/index.php/Admin/Assort/charts" class="count">统计</a>
	...
	<table>
        ...
        <tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td style="text-align:left;"><?php echo (str_repeat('---',$vol["level"])); echo ($vol["assortname"]); ?></td>
                <td><?php echo ((isset($vol["passortname"]) && ($vol["passortname"] !== ""))?($vol["passortname"]):"顶级栏目"); ?></td>
                <td><?php echo ($vol["sort"]); ?></td>
                <td><?php echo ($vol["remark"]); ?></td>
                <td>
                    <a href="/book1/index.php/Admin/Assort/edit/id/<?php echo ($vol["id"]); ?>">编辑</a>
                </td>
...
$(function(){
    ...
    //事件处理程序
        ...
        // console.log(id);
        //带着参数跳转到del方法
        window.location.href = '/book1/index.php/Admin/Assort/del/id/'+id;
    })
