...
<form action="" method="post">
	<div class="main">
	    <p class="short-input ue-clear">
	    	<label>栏目名称：</label>
			<input type="text" name="assortname" value="<?php echo ($data["assortname"]); ?>" placeholder="栏目名称" />
	    ...
	    <div class="short-input select ue-clear">
	        ...
	        <div class="select-wrap">
	        	<select name="pid">
					...
					<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vol["id"]); ?>" <?php if($vol["id"] == $data["pid"] ): ?>selected="selected"<?php endif; ?> > 
